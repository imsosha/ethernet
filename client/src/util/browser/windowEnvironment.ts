...
import { IS_ELECTRON, IS_TAURI } from './globalEnvironment';
...
export const IS_SERVICE_WORKER_SUPPORTED = 'serviceWorker' in navigator && !IS_ELECTRON && !IS_TAURI;

// Progressive streaming relies on Service Worker, which is not supported/reliable in Electron/Tauri custom protocols
