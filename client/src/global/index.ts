...
import { addCallback, removeCallback, typify } from '../lib/teact/teactn';
...
export const addGlobalCallback = addCallback;
export const removeGlobalCallback = removeCallback;
