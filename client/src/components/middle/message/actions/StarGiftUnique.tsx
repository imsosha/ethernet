...
import { getIsNftGiftsDisabled } from '../../../../util/ghostMode';
...
const StarGiftAction = ({
  ...
  const isNftDisabled = getIsNftGiftsDisabled();
  ...
  return (
    ...
    >
      ...
      >
        {isNftDisabled ? (
          <div className={styles.placeholderGift} style="display: flex; align-items: center; justify-content: center; width: 100%; height: 100%; font-size: 3rem; color: var(--color-primary); opacity: 0.8;">
            <Icon name="gift" />
          </div>
        ) : sticker && (
          <StickerView
