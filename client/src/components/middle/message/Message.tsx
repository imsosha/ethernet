...
import EthernetBadge from '../../common/EthernetBadge';
...
const Message = ({
  ...
  const containerClassName = buildClassName(
    ...
    message.isDeletedSpy && 'is-spy-deleted',
    (message.isEditedSpy || Boolean(message.editHistory?.length)) && 'is-spy-edited',
        ...
        {(senderTitle || asForwarded) ? (
          ...
          >
            ...
            <span className="message-title-name">
              ...
              {!asForwarded && <EthernetBadge peer={senderPeer} peerId={senderPeer?.id} />}
...
export default memo(withGlobal<OwnProps>(
  (global, ownProps): Complete<StateProps> => {
    ...
    const replyMessageChat = selectChat(global, replyToPeerId || chatId);
    ...
    const replyMessageSender = replyMessage ? selectSender(global, replyMessage)
      : forwardHeader && !isSystemBotChat && !isAnonymousForwards
        ...
        : selectPeer(global, replyToPeerId || chatId);
