  ...
  return (
    ...
    >
      ...
      <span className="message-time" title={dateTitle} onMouseEnter={markActivated}>
        ...
        {message.isDeletedSpy && (
          <Icon name="delete" className="message-spy-icon message-spy-deleted" />
        )}
        {(message.isEditedSpy || Boolean(message.editHistory?.length)) && (
          <Icon name="edit" className="message-spy-icon message-spy-edited" />
        )}
