...
type OwnProps = {
  ...
  onMarkAsRead?: NoneToVoidFunction;
  onSend?: NoneToVoidFunction;
  onReschedule?: NoneToVoidFunction;
  onClose: NoneToVoidFunction;
  onCloseAnimationEnd?: NoneToVoidFunction;
  onShowEditHistory?: NoneToVoidFunction;
  ...
  return (
    ...
    >
      ...
      >
        ...
        {canMarkRead && (
          <MenuItem icon="readchats" onClick={onMarkAsRead}>
            {getEthernetString(lang, 'EthernetMarkAsRead')}
          </MenuItem>
        )}
        {Boolean(message.editHistory?.length || message.isEditedSpy) && (
          <MenuItem icon="recent" onClick={onShowEditHistory}>
            {getEthernetString(lang, 'EthernetEditHistory')}
          </MenuItem>
        )}
        {canAppendTodoList && (
