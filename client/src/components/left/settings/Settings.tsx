...
import SettingsEthernetFunctions from './SettingsEthernetFunctions';
import SettingsEthernetNetwork from './SettingsEthernetNetwork';
import SettingsEthernetPlugins from './SettingsEthernetPlugins';
import SettingsEthernetThemes from './SettingsEthernetThemes';
import SettingsEthernetThemeEditor from './SettingsEthernetThemeEditor';
...
const Settings: FC<OwnProps> = ({
  ...
  const handleReset = useLastCallback((forceReturnToChatList?: true | Event) => {
    ...
    if (currentScreen === SettingsScreens.EthernetThemeEditor) {
      openSettingsScreen({ screen: SettingsScreens.EthernetThemes });
      return;
    }

    if (
      currentScreen === SettingsScreens.EthernetThemes
      || currentScreen === SettingsScreens.EthernetPlugins
      || currentScreen === SettingsScreens.EthernetFunctions
      || currentScreen === SettingsScreens.EthernetNetwork
    ) {
      openSettingsScreen({ screen: SettingsScreens.Ethernet });
      return;
    }

    if (currentScreen === SettingsScreens.Ethernet) {
  ...
  function renderCurrentSectionContent(isScreenActive: boolean, activeScreen: SettingsScreens) {
    ...
    switch (currentScreen) {
      ...
      case SettingsScreens.EthernetFunctions:
        return (
          <SettingsEthernetFunctions
            isActive={isScreenActive}
            onReset={handleReset}
          />
        );
      case SettingsScreens.EthernetNetwork:
        return (
          <SettingsEthernetNetwork
            isActive={isScreenActive}
            onReset={handleReset}
          />
        );
      case SettingsScreens.EthernetThemes:
        return (
          <SettingsEthernetThemes
            isActive={isScreenActive}
            onReset={handleReset}
          />
        );
      case SettingsScreens.EthernetPlugins:
        return (
          <SettingsEthernetPlugins isActive={isScreenActive} onReset={handleReset} />
        );
      case SettingsScreens.EthernetThemeEditor:
        return (
          <SettingsEthernetThemeEditor isActive={isScreenActive} onReset={handleReset} />
        );
