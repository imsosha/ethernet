...
const RichContent = ({
  ...
  function renderTopLevelBlock(block: ApiPageBlock, index: number) {
    ...
    const isLast = index === (blocks ? blocks.length - 1 : 0);
    ...
    return (
      <Breakout
        className={buildClassName(
          styles.mediaBreakout,
          isMessageContent && styles.paddedCaption,
          isMessageContent && isFirst && styles.firstInMessage,
          isMessageContent && isLast && styles.lastInMessage,
        )}
      >
        {content}
      </Breakout>
  ...
  return (
    <figure className={styles.figure}>
      <Video
        ...
        className={buildClassName(
          styles.mediaBlock,
          shouldBreakoutMedia && !context.isMessageContent && styles.noBorderRadius,
        )}
  ...
  return (
    <figure className={styles.figure}>
      <Slideshow
        ...
        observeIntersectionForLoading={context.observeIntersectionForLoading}
        observeIntersectionForPlaying={context.observeIntersectionForPlaying}
        className={shouldBreakoutMedia && !context.isMessageContent ? styles.noBorderRadius : undefined}
