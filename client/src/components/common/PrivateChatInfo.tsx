...
export default memo(withGlobal<OwnProps>(
  (global, {
    ...
    const targetUserId = isSavedDialog ? global.currentUserId! : userId;
    const effectiveThreadId = threadId || MAIN_THREAD_ID;
    const viewportIds = targetUserId ? selectViewportIds(global, targetUserId, effectiveThreadId) : undefined;
    const areMessagesLoaded = Boolean(
      !targetUserId
      || selectChatMessages(global, targetUserId)
